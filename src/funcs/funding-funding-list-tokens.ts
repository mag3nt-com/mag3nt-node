 ...
 */
export function fundingFundingListTokens(
  client: Mag3ntCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.FundingListTokensResponse,
    | Mag3ntError
...
> {
  const path = pathToFunc("/api/funding/tokens")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.FundingListTokensResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
