 ...
 */
export function fundingFundingVerify(
  client: Mag3ntCore,
  request: operations.FundingVerifyRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.FundingVerifyResponse,
    | errors.ErrorT
    | Mag3ntError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.FundingVerifyRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/fund/verify")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.FundingVerifyResponse$inboundSchema),
