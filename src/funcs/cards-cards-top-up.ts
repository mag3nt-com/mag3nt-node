 ...
 */
export function cardsCardsTopUp(
  client: Mag3ntCore,
  id: string,
...
> {
  const input: operations.CardsTopUpRequest = {
    id: id,
    body: body,
  };
  ...
  const parsed = safeParse(
    input,
    (value) => z.parse(operations.CardsTopUpRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/cards/{id}/fund")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CardsTopUpResponse$inboundSchema),
