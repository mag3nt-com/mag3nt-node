 ...
 */
export function ap2Ap2ListPaymentMethods(
  client: Mag3ntCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.Ap2ListPaymentMethodsResponse,
    | Mag3ntError
...
> {
  const path = pathToFunc("/api/ap2/payment-methods")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.Ap2ListPaymentMethodsResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
