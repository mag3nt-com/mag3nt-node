 ...
 */
export function fundingFundingGetBalance(
  client: Mag3ntCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.FundingGetBalanceResponse,
    | Mag3ntError
...
> {
  const path = pathToFunc("/api/balance")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.FundingGetBalanceResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
