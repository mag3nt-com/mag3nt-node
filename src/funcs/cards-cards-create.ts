 ...
 */
export function cardsCardsCreate(
  client: Mag3ntCore,
  request: operations.CardsCreateRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CardsCreateResponse,
    | errors.ErrorT
    | errors.BalanceError
    | Mag3ntError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.CardsCreateRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/issue")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CardsCreateResponse$inboundSchema),
