 ...
 */
export function withdrawalsWithdrawalsCreate(
  client: Mag3ntCore,
  request: operations.WithdrawalsCreateRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.WithdrawalsCreateResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.WithdrawalsCreateRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/withdraw")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.WithdrawalsCreateResponse$inboundSchema),
