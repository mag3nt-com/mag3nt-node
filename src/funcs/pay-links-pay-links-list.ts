 ...
 */
export function payLinksPayLinksList(
  client: Mag3ntCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PayLinksListResponse,
    | Mag3ntError
...
> {
  const path = pathToFunc("/api/paylinks")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PayLinksListResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
