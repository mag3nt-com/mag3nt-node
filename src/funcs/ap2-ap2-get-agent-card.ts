 ...
 */
export function ap2Ap2GetAgentCard(
  client: Mag3ntCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.Ap2GetAgentCardResponse,
    | Mag3ntError
...
> {
  const path = pathToFunc("/api/ap2/agent-card")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.Ap2GetAgentCardResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
